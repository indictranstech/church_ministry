...
def create_ftv(data):
	...
	if not valid:
		...
		try:
			...
			return "Something went wrong while creating first timer...! "
...
def get_master_details(data):
	...
	dictnory={
		...
		"Invitees and Contacts":"name,title,invitee_contact_name,sex,convert_invitee_contact_to_ft,date_of_convert,date_of_birth,age_group,member_name as invited_by,source_of_invitation,phone_1,email_id",
